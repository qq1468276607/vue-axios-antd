      ...
      <div class="table">
          ...
          >
            ...
            <span slot="action" slot-scope="text, record">
              ...
              <a v-if="record.cxuStatus == 0 && record.cxuId" @click="activateDeactivate('1',[record.userId])">激活</a><a v-else style="color: #DEDEDE">激活</a>
              <a v-if="record.cxuStatus == 1 && record.cxuId" @click="activateDeactivate('0',[record.userId])">停用</a><a v-else style="color: #DEDEDE">停用</a>
            </span>
          </a-table>
          <Pagenation
